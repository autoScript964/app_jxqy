...
//        publicFunction=mFairy.publicFunction;
    ...
    private boolean JZKH() throws Exception {
        ...
        result = publicFunction.localFindPic(904, 346, 1114, 498, "exam1.png");
        if (result.sim >= 0.8) {
    ...
    public void shzj() throws Exception {
        ...
        while (mFairy.condit()) {
            ...
            if (result.sim >= 0.8) {
                ...
                result = publicFunction.localFindPic(894, 126, 1076, 317, /*"shzj.png"+"|"+*/"fqqh.png");
                if (result.sim >= 0.8) {
                    LtLog.i(publicFunction.getLineInfo() + "发现活动");
                    publicFunction.rndTap(result.x + 19, result.y + 33, result.x + 89, result.y + 59);
                    Thread.sleep(3000);
            ...
            findResult = mFairy.findPic(13, 19, 107, 249, /*"shzj1.png"*/"fqqh1.png");
            if (findResult.sim > 0.8f) {
                ...
                switch (AtFairyConfig.getOption("shmap")) {
                    case "1":
                        mFairy.onTap(315, 116, 351, 142, "西北荒", 2000);
                        break;
                    case "2":
                        mFairy.onTap(265, 323, 284, 344, "西荒", 2000);
                        break;
                    case "3":
                        mFairy.onTap(287, 547, 322, 571, "西南荒", 2000);
                        break;
                    case "4":
                        mFairy.onTap(460, 418, 485, 437, "豫州", 2000);
                        break;
                    case "5":
                        mFairy.onTap(630, 159, 673, 179, "兖州", 2000);
                        break;
                    case "6":
                        mFairy.onTap(632, 320, 658, 342, "青丘", 2000);
                        break;
                    case "7":
                        mFairy.onTap(755, 432, 775, 449, "徐州", 2000);
                        break;
                    case "8":
                        mFairy.onTap(1019, 136, 1044, 155, "东北荒", 2000);
                        break;
                    case "9":
                        mFairy.onTap(1002, 346, 1035, 369, "东荒", 2000);
                        break;
                    case "10":
                        mFairy.onTap(962, 543, 998, 560, "东南荒", 2000);
                        break;
                }
            }
